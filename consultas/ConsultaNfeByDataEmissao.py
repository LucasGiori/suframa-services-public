...
def setDataByEmissao(headerkey,page,tipousuario,datainicial,datafinal):
    data={
        ...
        ,"FiltroPesquisa":"4"
        ,"OpcaoPeriodo":"1"
        ,"DataEmissaoInicio":"2020-04-01"
        ,"DataEmissaoFinal":"2020-04-26"
        ,"ValorTipoVistoria":"-1"
        ,"SituacaoProcesso":"12"
        ,"maxlength":"44"
        ,headerkey:"1"
...
def consultarNfeByDataEmissao(filial,cnpj,senha,headerkey,tipousuario,datainicial,datafinal):
    ...
    try:
        ...
        print("\n",negrito,verde,"Iniciando Conexão",restaura_cor_original)
        #conn,cursor= newConnection()
        for page in range(1,20):
            print(negrito,amarelo+"Scraping Page:", page,restaura_cor_original)
            #data_destinatario = setData(headerkey,page,tipousuario)
            data = setDataByEmissao(headerkey,page,tipousuario,datainicial,datafinal)
            
            
            url_base = "https://appsimnac.suframa.gov.br/ConsultarHistoricoNfeGrid?"+urlDict.urlencode(data)
            ...
            for i in dados_consultaNfe:
                ...
                cnpj = i["cnpjDestinatario"] if data["tipoUsuario"] == "2" else i["cnpjRemetente"]         
                ...
                print("\n\n",negrito,verde+"Número Pin: ",i["numeroPin"]," IdNfe: ",i["idNfe"],"Status PIN: ",i["dscSituacao"],restaura_cor_original)
                #print("\nHistórico: ","Type: ",type(historico),"\n",historico)
                print("\nErrorcode",errorcode)
        ...
        print("\n",negrito,verde,"Commit realizado",restaura_cor_original)
    except Exception as e :
        print("\n\nErro", e)
        pass
    exitSession(session)